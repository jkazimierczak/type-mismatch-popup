...
const style = {
  common:
    "box-border rounded border px-4 py-2 font-medium leading-5 transition-colors",
  ...
  outlined:
    "border-opacity-70 border-primary text-primary hover:border-opacity-100",
  outlinedDisabled: "",
    ...
    >
      ...
      >
        <span className={"flex items-center justify-center gap-2"}>
          ...
          <div
            className={clsx({
              "flex w-full justify-center": fullWidth,
            })}
          >
            {children}
          </div>
